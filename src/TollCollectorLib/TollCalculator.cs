...
public static class TollCalculator
{
    ...
    public static decimal GetBillAmount(object vehicle,
                                        DateTime timeOfToll,
                                        bool inbound)
    ...
    public static decimal CalculateToll(object vehicle)
    {
        return vehicle switch
        {
            ...
            Bus b when ((double)b.Riders / b.Capacity) < 0.50 => busBase + 2.00m,
            Bus b when ((double)b.Riders / b.Capacity) > 0.90 => busBase - 1.00m,
            Bus => busBase,

            DeliveryTruck tr when tr.GrossWeightClass > 5000 => deliveryTruckBase + 5.00m,
            DeliveryTruck tr when tr.GrossWeightClass < 3000 => deliveryTruckBase - 2.00m,
            DeliveryTruck => deliveryTruckBase,

            _ => throw new ArgumentException("Bad vehicle type", nameof(vehicle))
        };
    }
